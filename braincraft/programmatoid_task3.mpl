...
,[
 ...
 b_ii = H(g_c2 > g_c1),                            ###  Previous energy increase is higher.
 ### Updates direction
 q_p  = If(nd(b_id, b_i), 1 - q_p, q_p),   ### Changes direction if better choice detected.
 ###  Updates internal variables
 g_c2 = If(b_di, g_c1, g_c2),
 g_c1 = If(b_di, ge − ge1, b_ii, g_c1 + (g_e − g_e1), g_c1),
 g_e2 = g_e1,
 g_e1 = g_e,
