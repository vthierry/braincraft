...
#                self.b_t = (1 if self.b_t = 0 and self.data["p_a"] > 0.8 else 0 if self.b_t = 1 and self.data["p_a"] < 0.7 else self.b_t) if self.b_t30 == 0 and self.b_t3 == 0 else (1 if self.b_t30 = 1 and self.b_3w0 = 1 else 0 if self.b_t31 == 1 and self.b_3w1 == 1 else self.b_t)
