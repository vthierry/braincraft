...
then ## Runs at the programmatic level
    ...
    xterm -geometry 70x11+50+50 -sb -sl 10000 -rightbar -fa 'Monospace' -fs 18 -title 'programmatic challenge' -e sh -c "python3 $prgm.py 2>&1 | tee -a $l ; read -p 'Type enter to close' cont "
