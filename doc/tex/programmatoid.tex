...
\subsubsection{Programmatoid package meta-data and options}

Available options: \\\begin{tabular}{|l|l|l|l|} \hline
{\bf Name}                & {\bf Format}                & {\bf Value} & \\ \hline
 &&&\\\multicolumn{4}{|l|}{{\bf Package meta-data.}} \\
{\tt name} & string & \parbox{2cm}{set during \\ compilation} & \parbox{8cm}{The package name, deduced from the source file name, which is of the form {\tt name.mpl}.}\\
...
{\tt python}                & Boolean    &  true    & \parbox{8cm}{If defined, generates a Python piece of code with the flattened code.} \\ &&&\\
...
\subsubsection{Programmatoid compilation}
...
{\tt model[W]}             & matrix                    & \parbox{8cm}{The recurrent weights matrix (IN PROGRESS)}\\
