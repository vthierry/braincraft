...
\begin{document} \tableofcontents {\tt ~ Ongoing:
  ...
  \\+ Remanence des variables => dictionnaire en in/out-put ?
} \newpage
...
{\tt Python}                & Python's name    &            & \parbox{8cm}{If defined, generates a Python piece of code with the flattened code, defined as a function of the given {\tt name} and stored in a file of name {\tt name.py}.} \\ &&&\\
\hline \end{tabular}
