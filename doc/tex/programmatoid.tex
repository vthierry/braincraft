...
\item[Implementation] ~
\\- A simple sum or average could be used, thus using directly a linear combination of the input in afferent units. \\
 ...
 \\- We also can use a softmax mechanism as derived in the sequel, enjoying a neuronoid approximation,
  and allowing to balance between averaging and computing the maximum.
\\- We could also have considered the two lateral sensors of maximal angle, through less stable.
\end{description}
