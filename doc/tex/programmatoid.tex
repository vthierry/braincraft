...
%{\tt inputs}                 & List of names          &  deduced & \parbox{8cm}{The list of input variables, if it does not correspond to the right-hand side expression variables, not present in any left-hand side equation.} \\ &&&\\
%{\tt outputs}               & List of names          &  deduced & \parbox{8cm}{The list of output variables, if it does not correspond the left-hand side variables, not present in right-hand side expressions.} \\ &&&\\
