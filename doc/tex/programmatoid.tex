...
\\ \tab - we consider two leftward and rightward external sensors only,
...
\item[Motivation] Simplifies the left-right navigation by using as a simple pair of input.
\item[Implementation] ~
...
\\\tab (ii) perform a quarter-turn in the preferred orientation as soon as passing is aivalble.
...
\end{array}}  where: \eqline{\begin{array}{rcll}
    ...
    \alpha    &=& 5.0 & \mbox{\parbox{8cm}{Maximal tunr angle, allowing to perform a quatuer turn in $18$ time steps.}}} \\
...
\begin{verbatim}
Usage: programmatoid_challenge.sh [-h | [-s] $prgm]
  ...
  -h : shows this usage and exit.Usage ./programmatoid_challenge.sh $prgm
\end{verbatim}
