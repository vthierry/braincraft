...
\item[Programmatoid solution]:\eqline{\begin{array}{rcccc}
    d_l &\leftarrow& \mbox{if } q_t = 0 \mbox{ then } \gamma \, p_r  \mbox{ else } 0 & +&  \mbox{if } q_p = 0 \mbox { and } q_t = 1 \mbox{ then } \alpha \mbox{ else } 0 \\
    d_r &\leftarrow& \mbox{if } q_t = 0 \mbox{ then } \gamma \, p_l   \mbox{ else } 0 & +&  \mbox{if } q_p = 1 \mbox { and } q_t = 1 \mbox{ then } \alpha \mbox{ else } 0 \\
    ...
    q_t &\leftarrow& \multicolumn{3}{l}{\mbox{if } q_t = 0 \mbox { and } p_a > \beta \mbox{ then } 1 \mbox{ elif } q_t = 0 \mbox { and } q_d = 0 \mbox{ then } 0 \mbox{ else } q_t} \\
    \multicolumn{5}{l}{\mbox{Delay\_1}(q_d, q_t, \delta)} \\
\end{array}}  where: \eqline{\begin{array}{rcll}
    \gamma &=& 0.035 & \mbox{\parbox{8cm}{Maximize stability without oscillation.}} \\
    \alpha    &=& 5.0 & \mbox{\parbox{8cm}{Maximal turn angle, allowing to perform a quater turn in $18$ time steps.}} \\
    \delta    &=& 18 & \mbox{\parbox{8cm}{Quarter-turn duration in number of time steps.}} \\
    \beta     &=& 0.8 & \mbox{\parbox{8cm}{Proximity threshold that induces a quater turn.}} \\
\end{array}} in words: we execute the quarter-turn when a wall is detected ahead.
\end{description}
...
\begin{figure}[H]
  \includegraphics[width=0.5\textwidth,valign=c]{./starting-moves.png}
