...
\begin{figure}[H]
  ...
  \caption{Typical values of the maximal angle lateral sensors values in a corridor and before a quarter turn.}
...
\end{array}}  where: \eqline{\begin{array}{rcll}
    ...
    \alpha    &=& 0.0 & \mbox{\parbox{8cm}{Saturates the correction at $\pm$ 90° to make the quarter-turn, {\small since the linear $|\gamma \, (p_l - p_r)| < 40°$ is lower than the quarter-turn term, the latter summits the former.}}} \\
