...
In progress : \begin{itemize}

\item Ajouter tous les liens vers les fichiers maple
...
\item Sortir la doc du logiciel et faire lien vers doc

\item Creer section sur more mechanisms aec R/S memory etc.....
...
while:
\eqline{|\epsilon_{H,\omega}(x)| = e^{-4\,w}+O\left(e^{-8\,w}\right)}
