   ...
   \includegraphics[width=0.5\textwidth,valign=c]{./bistable1.png}
    \hfill \begin{minipage}{\dimexpr 0.5\linewidth-\columnsep}
      \caption{With: \eqline{\begin{array}{rcl}
         ...
         \end{array}}
         a bistable system with one two-way switch is implemented, using internal variables $i_0[t]$ and $i_1[t]$. This corresponds to a frequency divider by 2.
        }
        \label{bistable1}
    \end{minipage}
\end{figure}
   ...
   \includegraphics[width=0.5\textwidth,valign=c]{./delay1.png}
    \hfill \begin{minipage}{\dimexpr 0.5\linewidth-\columnsep}
      \caption{With: \eqline{\begin{array}{rcl}
         ...
         \end{array}}
        a delayed output is implemented. Assuming that $v[t] = 0$, when $i[t]=1$ and remains at this value, we obtain for the delay $T$:
   ...
   \includegraphics[width=0.5\textwidth,valign=c]{./astable1.png}
    \hfill \begin{minipage}{\dimexpr 0.5\linewidth-\columnsep}
      \caption{With: \eqline{\begin{array}{rcl}
             ...
             v[t] &\leftarrow& (1-\gamma) \, v[t-1] + \gamma \, (1 - o[t]) \, i[t] \\ 
         \end{array}}
        an binary oscillator is implemented. It is stopped if $i[t]=0$ and running for $i[t] = 1$. We obtain for the period $T$:
...
functions, defined previously, are implemented: \\\centerline{\begin{tabular}{ll}
  {\tt If(b\_1, v\_1, …, v\_0)} & Conditional expression with an odd number of arguments.\\
...
\end{tabular}} \\
In the present version the {\tt explog} mechanism is still to be implemented.
