...
\subsection{RS input/output gate}
...
For the second equation, assuming without loss of generality that $o(0) = 1$, since the situation is entirely symmetric, we obtain, in the worst case where $i(t) = 1$
\eqline{\begin{array}{rcl}
    o(t) &\leftarrow& h(-\omega/2)  + h(\omega \, 1/2) \\
\end{array}}
